...
public class IntList {
    ...
    public static IntList catenate(IntList A, IntList B) {
        ...
        IntList currA = A.rest;
        IntList C = new IntList(A.first, null);
        IntList p = C;
        while (currA != null) {
            p.rest = new IntList(currA.first, null);
            currA = currA.rest;
            p = p.rest;
        }
        ...
        IntList currB = B;
        while (currB != null) {
            p.rest = new IntList(currB.first, null);
            currB = currB.rest;
            p = p.rest;
        }
        return C;
    ...
    /**
     * Reverses and returns all the items of a given IntList
     */
    ...
    private static IntList reverseHelper(IntList front) {
        ...
        IntList toBeReversed = reverseHelper(front.rest);
